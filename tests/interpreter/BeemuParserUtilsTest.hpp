...
namespace BeemuTests {
	...
	public:
		...
		BeemuExplodeBeemuParamParameterizedTestFixture() : processor("default") {}
	protected:
		BeemuProcessorPreset processor;
		void SetUp() override {};
	...
	public:
		...
		BeemuExplodeBeemuParamUint16ParameterizedTestFixture() : processor("default") {}
	protected:
		BeemuProcessorPreset processor;
		void SetUp() override {};
		void TearDown() override {};
	...
	class BeemuExplodeBeemuParamTestFixture : public ::testing::Test {
	public:
		BeemuExplodeBeemuParamTestFixture() : processor("default") {}
	protected:
		BeemuProcessorPreset processor;
		void SetUp() override {};
		void TearDown() override {};
